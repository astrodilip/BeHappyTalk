  ...
  try {
    ...
    if (!providers || providers.length === 0) {
      ...
      const { error: insertErr } = await db.from('providers').insert([
        ...
        { id: 'p9', name: 'Kavya', phone: '9999999900', password: defaultPassword, verified: true, demographic: 'F · 25 yrs', rating: '4.78', reviews: '350+', tagline: 'Helping you navigate career decisions.', exp: '150+', langs: 'Hindi · English', status: 'online', priceChat: 11, priceCall: 20, priceVideo: 30, imagePath: 'avatars/provider9_avatar.png' },
